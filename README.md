...
3- Run:
git clone https://github.com/Johnnygereige/Sowlutions-CoderByte-take-home-exercise.git

then

cd Sowlutions-CoderByte-take-home-exercise

4- Inside vscode, Install an extension called "Live Server".
